with open("/Users/apple/Desktop/FLA/fla_automation_engine/engine/parser.py", "r") as f:
    lines = f.readlines()
...
with open("/Users/apple/Desktop/FLA/fla_automation_engine/engine/parser.py", "w") as f:
