"""
Run AOC4 for KUM India using the existing module pipeline.
Mirrors batch_populate_aoc4.py – points to /testing/KUM/ocr_output
"""
import os
import sys
...
def main():
    ...
    ocr_dir = "/Users/apple/Desktop/FLA/testing/KUM/ocr_output"
    out_dir = "/Users/apple/Desktop/FLA/testing/KUM/output"
    ...
    company_name = "KUM India Private Limited"
    safe_name    = "KUM_India_Private_Limited"
    ...
    try:
        ...
        # If a reference Excel is present, use it as CY source
        cy_source = docs.get("financials_excel", full_text)
